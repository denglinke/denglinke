  ...
  <div class="Atrtreport">
    <el-card class="card">
      <el-tabs v-model="activeName">
        <el-tab-pane label="工资报表" name="first"></el-tab-pane>
      </el-tabs>
      <div class="btn">
      ...
      <el-table :data="tableData" border>
        ...
        <el-table-column
          ...
          width="140"
        ></el-table-column>
        <el-table-column prop="currentBaseSalary" label="基本工资" width="100">
        </el-table-column>
        <el-table-column prop="baseSalaryByMonth" label="岗位工资" width="100">
        </el-table-column>
        <el-table-column prop="salaryChangeAmount" label="福利津贴" width="100">
        </el-table-column>
        <el-table-column
        ...
        <el-table-column prop="salaryByTax" label="应纳税工资" width="100">
        </el-table-column>
        <el-table-column prop="salaryBeforeTax" label="应扣税" width="100">
        </el-table-column>
        <el-table-column prop="payment" label="实发工资" width="100">
        </el-table-column>
      </el-table>
      <!-- 分页 -->
      ...
      <!-- 底部按钮 -->
      <div class="but">
        <el-button size="mini" type="primary">归档03报表</el-button>
