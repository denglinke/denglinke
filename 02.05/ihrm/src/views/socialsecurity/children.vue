			...
			<div class="box">
				...
				<div class="right">
					...
					<div class="con">
						...
						<span class="span">入职时间：<span>{{
							userInfo.timeOfEntry ? userInfo.timeOfEntry.slice(0, 10) : ""
						}}</span></span>
						<span class="span">联系电话：<span>{{ userInfo.mobile }}</span></span>
					</div>
					<div class="foot">
						<span>本月不缴纳社保 <el-switch v-model="value" active-color="#13ce66" inactive-color="#ff4949">
							</el-switch></span>
						<span>本月不缴纳公积金 <el-switch v-model="value1" active-color="#13ce66" inactive-color="#ff4949">
							</el-switch></span>
					</div>
				</div>
			</div>
			...
			<div class="form">
				<el-form :model="userSecurity" label-width="80px" size="mini">
					<el-form-item label="参保城市">
						<el-select v-model="userSecurity.participatingInTheCity" placeholder="请选择">
					...
					<el-form-item label="社保缴纳">
						<div class="input">
							<div>
								...
								<el-input v-model="userSecurity.socialSecurityType" disabled style="width: 160px"></el-input>
							</div>
							<div>
								<span style="font-size: 14px; font-weight: 900; margin-left: 10px">公司：</span>
								<el-input v-model="userSecurity.socialSecurityType" disabled style="width: 160px"></el-input>
							</div>
						</div>
					</el-form-item>
				...
				<div class="form">
					<el-form :model="userSecurity" label-width="100px" size="mini">
						<el-form-item label="社保备注">
							<el-input v-model="userSecurity.socialSecurityNotes" type="textarea" style="width: 400px"></el-input>
						</el-form-item>
						<el-form-item label="公积金城市">
							<el-select v-model="userSecurity.providentFundCity" placeholder="请选择">
								<el-option label="北京" value="beijing"></el-option>
							</el-select>
						</el-form-item>
						...
						<el-form-item label="企业比例">
							<div class="input">
								<el-input v-model="userSecurity.enterpriseProportion"></el-input>
						...
						<el-form-item label="公积金缴纳">
							<div class="input">
								<div>
									<span style="font-size: 14px; font-weight: 900">个人：</span>
									<el-input style="width: 160px" v-model="userSecurity.personalProvidentFundPayment"></el-input>
								</div>
								<div>
									<span style="font-size: 14px; font-weight: 900; margin-left: 10px">公司：</span>
									<el-input style="width: 160px" v-model="userSecurity.enterpriseProvidentFundPayment"></el-input>
								</div>
								<span>（为自动测算结果，可手动调整）</span>
							</div>
						</el-form-item>
						<el-form-item label="公积金备注">
							<el-input type="textarea" style="width: 400px" v-model="userSecurity.providentFundNotes"></el-input>
						</el-form-item>
					</el-form>
				</div>
			</div>
